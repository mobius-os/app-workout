...
- **Log** — your entries grouped into sessions (entries within 4 hours of each other share a session) plus a bounded, resizable Workout chat. A follow-up like "another set with 90" resolves in the ongoing chat context.
